    ...
    <nav className="bg-blue-700 border-b border-blue-500">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        ...
        <div className="relative flex h-20 items-center justify-between">
          ...
          >
            {/* <!-- Logo --> */}
            <Link className="flex flex-shrink-0 items-center" href="/property">
              <Image
            ...
            <div className="hidden md:ml-6 md:block">
              <div className="flex space-x-2">
                <Link
                  href="/property"
                  className={`${pathname === '/property' ? 'bg-blue-950' : ''} text-white hover:bg-slate-700 hover:text-white rounded-md px-3 py-2`}
                >Home</Link>
                <Link
      ...
      {isMenuOpen && (
        <div id="mobile-menu">
          <div className="space-y-1 px-2 pb-3 pt-2">
            <Link
              href="/property"
              className={`${pathname === '/property' ? 'bg-blue-950' : ''}  text-white block rounded-md px-3 py-2 text-base font-medium`}
            >Home</Link>
            <Link
              href="/property/properties"
